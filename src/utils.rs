...
pub fn get_entity_model(entity: &EntityKind) -> (&str, &str) {
    match entity {
        ...
        EntityKind::Husk       => ("entitymodel-zombie.b3d" , "entity-zombie-husk.png"),
        EntityKind::Illusioner => ("entitymodel-illusioner.b3d", "entity-illager-illusioner.png"),
        EntityKind::IronGolem  => ("entitymodel-iron_golem.b3d", "entity-iron_golem-iron_golem.png"),
        EntityKind::Llama      => ("entitymodel-llama.b3d"  , "entity-llama-creamy.png"),
        EntityKind::MagmaCube  => ("entitymodel-magmacube.b3d", "entity-slime-magmacube.png"),
        EntityKind::Minecart   => ("entitymodel-minecart.b3d", "entity-minecart.png"),
        EntityKind::Mooshroom  => ("entitymodel-cow.b3d"    , "entity-cow-red_mooshroom.png"),
        EntityKind::Mule       => ("entitymodel-horse.b3d"  , "entity-horse-mule.png"),
        EntityKind::Ocelot     => ("entitymodel-cat.b3d"    , "entity-cat-ocelot.png"),
        EntityKind::Parrot     => ("entitymodel-parrot.b3d" , "entity-parrot-parrot_red_blue.png"),
        EntityKind::Pig        => ("entitymodel-pig.b3d"    , "entity-pig-pig.png"),
        EntityKind::Piglin     => ("entitymodel-sword_piglin.b3d", "entity-piglin-piglin.png"),
        EntityKind::PiglinBrute => ("entitymodel-sword_piglin.b3d", "entity-piglin-piglin_brute.png"),
        EntityKind::Pillager   => ("entitymodel-pillager.b3d", "entity-illager-pillager.png"),
        EntityKind::PolarBear  => ("entitymodel-polarbear.b3d", "entity-bear-polarbear.png"),
        EntityKind::Rabbit     => ("entitymodel-rabbit.b3d" , "entity-rabbit-brown.png"),
        EntityKind::Salmon     => ("entitymodel-salmon.b3d" , "entity-fish-salmon.png"),
        EntityKind::Sheep      => ("entitymodel-sheepfur.b3d", "entity-sheep-sheep_fur.png"),
        EntityKind::Shulker    => ("entitymodel-shulker.b3d", "entity-shulker-shulker.png"),
        EntityKind::Silverfish => ("entitymodel-silverfish.b3d", "entity-silverfish.png"),
        EntityKind::Skeleton   => ("entitymodel-skeleton.b3d", "entity-skeleton-skeleton.png"),
        EntityKind::Slime      => ("entitymodel-slime.b3d"  , "entity-slime-slime.png"),
        EntityKind::SnowGolem  => ("entitymodel-snowman.b3d", "entity-snow_golem.png"),
        EntityKind::SpawnerMinecart => ("entitymodel-minecart_block.b3d", "entity-minecart.png"),
        EntityKind::Spider     => ("entitymodel-spider.b3d" , "entity-spider-spider.png"),
        EntityKind::Squid      => ("entitymodel-squid.b3d"  , "entity-squid-squid.png"),
        EntityKind::Stray      => ("entitymodel-stray.b3d"  , "entity-skeleton-stray.png"), //TODO layered
        EntityKind::Strider    => ("entitymodel-strider.b3d", "entity-strider.png"),
        EntityKind::TntMinecart => ("entitymodel-minecart_block.b3d", "entity-minecart.png"),
        EntityKind::TraderLlama => ("entitymodel-llama.b3d" , "entity-llama-brown.png"),
        EntityKind::TropicalFish => ("entitymodel-tropical_fish_a.b3d", "entity-fish-tropical_a.png"), // a/b textures with patterns. no way am i going to deal with that
        EntityKind::Vex        => ("entitymodel-vex.b3d"    , "entity-illager-vex.png"),
        EntityKind::Villager   => ("entitymodel-villager.b3d", "entity-villager-villager.png"),
        EntityKind::Vindicator => ("entitymodel-vindicator.b3d", "entity-illager-vindicator.png"),
        EntityKind::WanderingTrader => ("entitymodel-villager.b3d", "entity-wandering_trader.png"),
        EntityKind::Warden     => ("entitymodel-iron_golem.b3d", "entity-warden-warden.png"),
        EntityKind::Witch      => ("entitymodel-witch.b3d"  , "entity-witch.png"),
        EntityKind::Wither     => ("entitymodel-wither.b3d" , "entity-wither-wither.png"),
        EntityKind::WitherSkeleton => ("entitymodel-witherskeleton.b3d", "entity-skeleton-wither_skeleton.png"),
        EntityKind::Wolf       => ("entitymodel-wolf.b3d"   , "entity-wolf-wolf.png"),
        EntityKind::Zoglin     => ("entitymodel-hoglin.b3d" , "entity-hoglin-zoglin.png"),
        EntityKind::Zombie     => ("entitymodel-zombie.b3d" , "entity-zombie-zombie.png"),
        EntityKind::ZombieHorse => ("entitymodel-horse.b3d" , "entity-horse-horse_zombie.png"),
        EntityKind::ZombieVillager => ("entitymodel-villager.b3d", "entity-zombie_villager-zombie_villager.png"),
        EntityKind::ZombifiedPiglin => ("entitymodel-sword_piglin.b3d", "entity-piglin-zombified_piglin.png"),
        EntityKind::Player     => ("entitymodel-armor_character.b3d", "entity-player-wide-steve.png"),
        _ => ("entitymodel-pig.b3d", "entity-pig-pig.png")
    }
}
