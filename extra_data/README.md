...
Point the three scripts at an unpacked client jar.
...
python3 scripts/banner_patterns.py /path/to/unpacked/client
```
...
* banner_patterns.json  
    Needed by bridgetest to know which patterns a loom offers.
    Generated by the "banner_patterns.py" script.
