...
pub fn get_entity_model(entity: &EntityKind) -> (&str, Vec<String>) {
    match entity {
        ...
        EntityKind::CommandBlockMinecart => ("entitymodel-minecart_block.b3d", vec![String::from("entity-minecart.png")]),
        EntityKind::Cow        => ("entitymodel-cow.b3d"     , vec![String::from("entity-cow-cow.png")]),
        ...
        EntityKind::FurnaceMinecart => ("entitymodel-minecart_block.b3d", vec![String::from("entity-minecart.png")]),
        ...
        EntityKind::Mooshroom  => ("entitymodel-cow.b3d"     , vec![String::from("entity-cow-red_mooshroom.png")]),
        ...
        EntityKind::Piglin     => ("entitymodel-sword_piglin.b3d", vec![String::from("entity-piglin-piglin.png")]),
        EntityKind::PiglinBrute => ("entitymodel-sword_piglin.b3d", vec![String::from("entity-piglin-piglin_brute.png")]),
        EntityKind::Pillager   => ("entitymodel-pillager.b3d", vec![String::from("entity-illager-pillager.png")]),
        ...
        EntityKind::Skeleton   => ("entitymodel-skeleton.b3d", vec![String::from("entity-skeleton-skeleton.png")]),
        ...
        EntityKind::SpawnerMinecart => ("entitymodel-minecart_block.b3d", vec![String::from("entity-minecart.png")]),
        ...
        EntityKind::TntMinecart => ("entitymodel-minecart_block.b3d", vec![String::from("entity-minecart.png")]),
        ...
        EntityKind::Vindicator => ("entitymodel-vindicator.b3d", vec![String::from("entity-illager-vindicator.png")]),
        ...
        EntityKind::ZombifiedPiglin => ("entitymodel-sword_piglin.b3d", vec![String::from("entity-piglin-zombified_piglin.png")]),
